...
class ABCDSampler(torch.nn.Module):
	"""
	"A"ttention-"B"ased "C"ategorical distribution with the "D"irichlet prior.
	"""
	def __init__(self,
			input_size,
			mlp_hidden_size,
		...
		super(ABCDSampler, self).__init__()
